...
import ForgottenPasswordDialog from '../../../app/shared-components/dedicated/LHDialogs/SubjectDialog';
...
function DemoContent() {
	...
	return (
		<div>
			...
			<div className="general-alert-dialog">
			<Typography variant="body1" onClick={handleOpen} sx={{textDecoration: 'underline', cursor: 'pointer'}}>
				Open subject
			</Typography>
			<SubjectDialog
				open={open}
