...
const Root = styled(List)<ListComponentProps>(({ theme, ...props }) => ({
	...
	'& > .fuse-list-item': {
		...
		fontSize: '1.5rem', // --> To decrease the size of the collapse nav
		'&:hover': {
				...
				>
					...
					<ListItemText
						...
						classes={{
							...
							primary: 'text-15 font-medium fuse-list-item-text-primary truncate', // --> To make font smaller
							secondary: 'text-13 font-medium fuse-list-item-text-secondary leading-normal truncate' // --> To make font smaller
						}}
					/>
					...
					>
						<FuseSvgIcon
							...
							color={theme.palette.common.black} // --> To set the color of the arrow in the colapse
						>
