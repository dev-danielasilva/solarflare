...
import SessionSlideshow from 'app/shared-components/general/SessionSlideshow/SessionSlideshow';
...
function Layout1(props: Layout1Props) {
	...
	const isSlideshow = pathname[pathname.length - 1] === 'slideshow';
