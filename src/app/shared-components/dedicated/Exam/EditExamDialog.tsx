import { Alert, Button, DialogContent, DialogTitle, FormControlLabel, FormGroup, Switch, Typography } from '@mui/material';
...
function EditExamDialog({ open, handleClose, todo, sendUpdatedTodo }) {
