...
interface Column {
	id: 'full_name' | 'submission_date' | 'score' | 'download' | 'preview';
	label: string;
	minWidth?: number;
	align?: 'right' | 'center';
...
const columns: readonly Column[] = [
	...
	{ id: 'download', label: '', minWidth: 50, align: 'center' },
...
export default function TodoResultsTable({ onPreview }) {
