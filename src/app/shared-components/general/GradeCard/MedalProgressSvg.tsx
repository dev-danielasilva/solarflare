...
function MedalProgressSvg({ grade, color, changeColor, maxGrade }: MedalProgressSvgProps) {
		...
		>
			{percentage > 0 && percentage <= 10 && (
				<path
					id="_10_"
					data-name="10%"
					style={{ fill: color, strokeWidth: '0px', opacity: changeColor ? 0.3 : 1 }}
					d="M25.39,89.82s3.7-4.56,8.37-4.56,11.75,5.78,21.09,5.3,17.23-3.86,17.23-3.86l-5.64,5.96-7.57,4.99-8.82-1.45-6.31-3.86-8.15,2.05-8.44-2.05-1.77-2.51Z"
				/>
			)}
			{percentage > 10 && percentage <= 20 && (
				<path
					...
					data-name="20%"
					style={{ fill: color, strokeWidth: '0px', opacity: changeColor ? 0.3 : 1 }}
					d="M18.79,80.7s10.3-4.56,19.64-4.56,18.62,9.63,29.18,9.12,19.93-4.55,19.93-4.55l-7.9,5.99h-7.24l-5.8,5.64-6.76,4.83-8.86-1.5-6.12-3.65-10.62,2.37-8.21-3.18-7.25-10.51Z"
				/>
			)}
			{percentage > 20 && percentage <= 30 && (
				<path
					...
					data-name="30%"
					style={{ fill: color, strokeWidth: '0px', opacity: changeColor ? 0.3 : 1 }}
					d="M6.87,71.57s17.07,4.56,26.4,4.56,27.87-9.12,40.74-9.12,14.97,4.56,14.97,4.56l-1.93,9.97-6.44,5.31h-7.73l-7.41,5.64-5.96,4.67-12.56-2.78-7.41-2.05-6.44,3.33-9.02-8-2.74-5.57-9.5-4.57-4.99-5.94Z"
				/>
			)}
			{percentage > 30 && percentage <= 40 && (
				<path
					...
					data-name="40%"
					style={{ fill: color, strokeWidth: '0px', opacity: changeColor ? 0.3 : 1 }}
					d="M7.19,62.65s17.2-4.44,28.4-4.44,32.94,8.8,40.67,8.8,19.48-4.48,19.48-4.48l-5.96,4.56-1.29,7.69-1.29,4.55-3.38,5.11-9.82,2.42-6.4,2.96-4.71,5.84-5.31,1.98-6.76-1.98-5.96-3.17-9.27,1.89-6.02-1.24-5.31-5.15-3.89-7.29-8.51-3.18-5.64-7.08.97-7.78Z"
				/>
			)}
			{percentage > 40 && percentage <= 50 && (
				<path
					...
					data-name="50%"
					style={{ fill: color, strokeWidth: '0px', opacity: changeColor ? 0.3 : 1 }}
					d="M7.19,58.21s12.56-9.12,22.38-9.12,34.45,9.46,45.08,8.88,21.61-7.5,21.61-7.5l2.22,5.96-4.35,7.89-4.51,2.78-3.38,15.26-13.52,4.34-5.11,3.12-6.96,6.54-7.81.64-7.98-4.35-10.46,1.73-7.73-2.69-4.03-7.08-5.18-5.27-8.35-3.2-2.9-7.31.97-10.61Z"
				/>
			)}
			{percentage > 50 && percentage <= 60 && (
				<path
					...
					data-name="60%"
					style={{ fill: color, strokeWidth: '0px', opacity: changeColor ? 0.3 : 1 }}
					d="M1.88,44.67s17.56,4.42,27.21,4.42,27.53-9.12,46.05-9.12,21.13,7.92,21.13,7.92l2.22,5.76s-3.06,9.32-6.76,12-1.45,12.52-5.64,16.7-10.14,3.37-13.85,4.98-6.92,7.89-11.75,9.5-11.93-4.35-15.62-4.51-8.9,3.68-14.48,2.05-6.32-8.92-10-13-10.77-2.02-13.5-8.86.97-10.63.64-13.85-5.47-9.31-5.64-14.01Z"
				/>
			)}
			{percentage > 60 && percentage <= 70 && (
				<path
					...
					data-name="70%"
					style={{ fill: color, strokeWidth: '0px', opacity: changeColor ? 0.3 : 1 }}
					d="M10.41,30.85s20.81,9.12,39.55,9.12,28.87-9.12,35.48-9.12,8.86,4.02,8.86,4.02l-1.61,8.51,5.47,10.27-1.9,7.6-6.96,5.84-1.45,9.04-3.54,9.12-7.89,1.44h-4.19l-11.43,9.82h-7.89l-8.06-3.86-9.27,1.73-8.76-1.24-4.51-8.53-6.44-5.27-7.25-4.39-2.58-10.3v-9.02l-4.03-9.5,1.62-8.21,6.76-7.06Z"
				/>
			)}
